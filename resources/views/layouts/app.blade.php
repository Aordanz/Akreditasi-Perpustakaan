...
<body class="text-slate-800 antialiased flex flex-col min-h-screen">
    ...
    <!-- Sleek Dark Footer -->
    <footer class="bg-slate-900 text-slate-300 pt-16 pb-8 border-t-4 border-[#0a7a3b] mt-auto relative overflow-hidden">
        <!-- Abstract shape in footer -->
        <div class="absolute top-0 right-0 -mr-20 -mt-20 w-64 h-64 rounded-full bg-[#0a7a3b] opacity-10 blur-3xl pointer-events-none"></div>
        <div class="absolute bottom-0 left-0 -ml-20 -mb-20 w-80 h-80 rounded-full bg-[#fecb00] opacity-5 blur-3xl pointer-events-none"></div>
        
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            <div class="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
                <div class="col-span-1 md:col-span-2">
                    <a href="/" class="flex items-center gap-3 mb-6 group">
                        <div class="bg-white p-1.5 rounded-xl group-hover:shadow-[0_0_15px_rgba(254,203,0,0.5)] transition duration-300">
                            <img src="{{ asset('logousu.jpeg') }}" alt="Logo USU" class="w-10 h-10 object-contain">
                        </div>
                        <div>
                    ...
                    <div class="flex gap-4">
                        <a href="#" class="w-10 h-10 rounded-full bg-slate-800 flex items-center justify-center hover:bg-[#0a7a3b] hover:text-white transition-all duration-300 transform hover:-translate-y-1">
                ...
                <div>
                    <h3 class="text-white font-bold mb-4 uppercase tracking-wider text-sm border-b border-slate-800 pb-2">Tautan Cepat</h3>
                    <ul class="space-y-3">
                        <li><a href="#" class="text-slate-400 hover:text-[#fecb00] hover:translate-x-1 inline-block transition-all duration-300">Profil Perpustakaan</a></li>
                        <li><a href="#" class="text-slate-400 hover:text-[#fecb00] hover:translate-x-1 inline-block transition-all duration-300">Layanan Anggota</a></li>
                        <li><a href="/akreditasi" class="text-slate-400 hover:text-[#fecb00] hover:translate-x-1 inline-block transition-all duration-300">Akreditasi & Mutu</a></li>
                        <li><a href="#" class="text-slate-400 hover:text-[#fecb00] hover:translate-x-1 inline-block transition-all duration-300">Repositori Institusi</a></li>
                    </ul>
                </div>
                
                <div>
                    <h3 class="text-white font-bold mb-4 uppercase tracking-wider text-sm border-b border-slate-800 pb-2">Kontak Kami</h3>
                    <ul class="space-y-4 text-slate-400">
                        <li class="flex items-start gap-3 hover:text-white transition-colors duration-300">
                            <svg class="w-5 h-5 text-[#0a7a3b] shrink-0 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z"></path><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 11a3 3 0 11-6 0 3 3 0 016 0z"></path></svg>
                        ...
                        <li class="flex items-center gap-3 hover:text-white transition-colors duration-300">
                            <svg class="w-5 h-5 text-[#0a7a3b] shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z"></path></svg>
                            <span class="text-sm">+62 61 8218666</span>
                        </li>
                        <li class="flex items-center gap-3 hover:text-white transition-colors duration-300">
                            <svg class="w-5 h-5 text-[#0a7a3b] shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z"></path></svg>
            ...
            <div class="pt-8 border-t border-slate-800 text-center md:flex md:justify-between md:items-center text-xs md:text-sm text-slate-500">
